...
# Create test data
n_trans = 1000  # Even more time points
n_points = 50000  # More points

# Create complex data for testing
complex_data = np.random.randn(n_trans, n_points) + 1j * np.random.randn(n_trans, n_points)

print(f"Benchmarking temporal difference calculation with {n_trans} time points and {n_points} spatial points...")
